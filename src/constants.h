...
const Color GREEN_GAME_COLOR = {46, 204, 113, 255};
const Color BLUE_GAME_COLOR = {52, 152, 219, 255};
const Color YELLOW_GAME_COLOR = {241, 196, 15, 255};
const Color ORANGE_GAME_COLOR = {230, 126, 34, 255};
